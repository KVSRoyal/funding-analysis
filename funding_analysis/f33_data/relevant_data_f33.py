...
class RelevantData:
    ...
    def __init__(self):
        ...
        workbook_path = pathlib.Path(__file__).parents[2] / 'resources' / 'raw_f33_data'

        # Load the relevant raw data table as a pandas data frame
        relevant_raw_data_workbook_path = workbook_path / 'relevant_raw_data.xls'
        ...
        nonexhibit_items_workbook_path = workbook_path / 'nonexhibit_items.xls'
