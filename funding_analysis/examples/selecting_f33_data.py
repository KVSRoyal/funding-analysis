# An example of a script that will allow users to sample data in pandas dataframes from the relevant_raw_data file
import pathlib
import pandas

# Open the relevant sheet in the elementary-secondary financial data for 2016 workbook as a dataframe
workbooks_directory_path = pathlib.Path(__file__).parents[2] / 'resources' / 'raw_f33_data'
